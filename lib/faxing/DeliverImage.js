...
var deliverImage = async function (pdfFile,callingNumber,calledNumber) {

 var device = await dbCommands.lookupAccountIdByFaxNo(callingNumber); 
 var messageType = '1';
 ...
 var options = { method: 'POST',
   ...
   formData:
    { ServiceName: 'ConnectorService',
      ...
      AccountId: device.dataValues.username,
