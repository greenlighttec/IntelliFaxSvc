...
// Generic Update Record Statement.
		...
		switch (recordType) {
			...
			case "Devices":
				if (statement.password) {
					hashPassword(statement.password, hashedpassword => statement.password = hashedpassword)
				}
			...
			case "Users":
				if (statement.password) {
					...
					hashPassword(statement.password, (hashedpassword) => {statement.password = hashedpassword; console.log('Hashed '+ hashedpassword)})
				}
